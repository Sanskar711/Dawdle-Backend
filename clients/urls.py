...
from .views import ClientViewSet, ProductViewSet, ProspectViewSet, MeetingViewSet, UserProductsView,AssignedProductsView
...
urlpatterns = [
    ...
    path('products/<int:pk>/prod_info/', ProductViewSet.as_view({'get': 'usecases'}), name='product-usecases'),
